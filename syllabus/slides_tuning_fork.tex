...
\hfill\includegraphics[width=.4\linewidth]{slide4}
...
\only<2>{\includegraphics[width=0.48\linewidth]{DSC_2942.JPG}
...
\hfill\includegraphics[width=.3\linewidth]{biasT}
...
\only<1>{
\vspace*{-1.52cm}
\hspace*{7.5cm}\includegraphics[width=0.47\linewidth]{fig7}
\vspace*{-1.62cm}
}
...
\vspace*{-2.93cm}\hspace*{7.5cm}\includegraphics[width=0.49\linewidth]{oversampling.pdf}
\vspace*{-0.3cm}
}
...
\vspace*{-4.7cm}
\hspace*{7.5cm}\includegraphics[width=0.49\linewidth]{fonction_de_transfert.pdf}
}
\end{enumerate}
\end{frame}
